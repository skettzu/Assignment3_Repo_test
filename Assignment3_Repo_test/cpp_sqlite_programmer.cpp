...
int main(int argc, char** argv)
{
	...
	*******************************************************************
	...
	cout << endl
		<< query << endl; // print the string to screen
	...
	*********************************************
	...
	cout << endl
		<< "Enter the first name, last name, and birth year of a famous programmer separated by spaces: ";
	...
	***********************************/
	string course = "SELECT Title FROM COURSES WHERE department = 'BSCO';";
	cout << endl
		<< "SQL Command: " << course << endl;
	cout << "The following courses are taught in BSCO" << endl;
	exit = sqlite3_exec(DB, course.c_str(), callback, NULL, NULL);
	if (exit != SQLITE_OK) {
		cout << "error";
	}
